# Diagnose and fix Tailscale on Snapmaker U1 from Windows
# Usage: .\diagnose-tailscale.ps1
# This script runs diagnose-tailscale.sh on the U1 via plink
...
Write-Host "=== Diagnosing Tailscale on $SSH_USER@$TARGET_IP ==="
...
$content = [System.IO.File]::ReadAllText('diagnose-tailscale.sh')
$content = $content.Replace("`r`n", "`n")

# Run the diagnose script via plink
